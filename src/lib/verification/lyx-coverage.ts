...
export const lyxParityCoverageRegistry: LyxParityCoverageEntry[] = [
  ...
  coverage("module-enable-disable", {
    status: "supported",
    implementation: supportedAll,
    canonicalAstMapping: ["CanonicalDocumentSettings.modules", "CanonicalDocumentSettings.enabledModules", "upstream-backed LyX module registry"],
    tiptapEditorMapping: ["document settings surface", "supported LyX module panel", "module-aware editor surface"],
    latexSerializerMapping: ["module-dependent package and macro emission", "registry-backed module wrappers"],
    previewRendererMapping: ["compiled package-sensitive PDF output", "module-aware preview recompilation"],
    ...
    verificationFixtureIds: [...workspaceTests, ...serializerTests, ...compilerTests, ...browserWorkflowVerification],
    gaps: ["The product surface currently exposes the supported LyX module subset that can round-trip through the editor and bundled PDF preview; the full upstream registry is retained internally for audit and future expansion."],
  }),
  ...
  coverage("find-replace", {
    ...
    canonicalAstMapping: ["replaceAllInCanonicalDocument", "CanonicalInline text traversal"],
    tiptapEditorMapping: ["Find and replace workspace panel"],
    latexSerializerMapping: ["canonical serializer after replacement"],
    previewRendererMapping: ["live preview invalidation after canonical replacement"],
  ...
  coverage("paste-special", {
    ...
    canonicalAstMapping: ["pasteSpecialToCanonicalBlocks", "tiptapDocumentToCanonicalPatch"],
    tiptapEditorMapping: ["Paste special workspace panel"],
    latexSerializerMapping: ["canonical serializer after paste insertion"],
    previewRendererMapping: ["live preview invalidation after paste insertion"],
    canonicalFixtureIds: ["fixture-restoration-foundation"],
    verificationFixtureIds: [
      "src/lib/editor-core/__tests__/document-workflows.test.ts",
      ...workspaceTests,
    ...
    gaps: ["LaTeX, HTML, and plain text paste paths are implemented; PDF/image clipboard conversion is not implemented."],
  ...
  coverage("multi-view-bookmarks-fullscreen", {
    ...
    canonicalAstMapping: [],
    tiptapEditorMapping: ["Document statistics workspace panel", "calculateDocumentStatistics"],
    latexSerializerMapping: [],
    previewRendererMapping: ["statistics panel reacts to canonical document changes"],
    canonicalFixtureIds: [],
    verificationFixtureIds: ["src/lib/editor-core/__tests__/document-workflows.test.ts", ...workspaceTests],
  ...
  coverage("statistics-preferences-reconfigure", {
    ...
    gaps: ["Document statistics are implemented; preferences and reconfigure/admin surfaces remain deferred."],
    oracleExemption: "Statistics/preferences/reconfigure is editor environment behavior with no stable LaTeX export signature.",
  }),
